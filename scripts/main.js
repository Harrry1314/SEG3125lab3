...
function populateListProductChoices(slct1, slct2) {
	...
	for (i = 0; i < optionArray.length; i++) {
		...
		if(productName.name=="bread")
		{
			pic.src="bread.jpg";
			pic.height=100;
			pic.width=100;
		}
		else if(productName.name=="brocoli")
		{
			pic.src="brocoli.jpg";
			pic.height=100;
			pic.width=100;
		...
		else if(productName.name=="chicken")
		{
			pic.src="chicken.jpg";
			pic.height=100;
			pic.width=100;
		...
		else if(productName.name=="cucumber")
		{
			pic.src="cucumber.jpg";
			pic.height=100;
			pic.width=100;
		}
		...
		//s2.appendChild(document.createElement("AAAAAAAA"));
...
function selectedItems(){
	...
	for (i = 0; i < ele.length; i++) { 
		if (ele[i].checked) {
			...
			//para.appendChild(document.createTextNode("AAAB"));
			para.appendChild(document.createElement("br"));
